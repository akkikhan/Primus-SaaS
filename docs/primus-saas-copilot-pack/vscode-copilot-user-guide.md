...
If your tooling supports project-level instructions (e.g., Cursor, Copilot Enterprise), paste the contents of `copilot-rules.txt` into the project/system instructions.
