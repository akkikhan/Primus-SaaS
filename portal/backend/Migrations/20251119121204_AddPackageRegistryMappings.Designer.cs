...
namespace PrimusSaaS.Portal.Api.Migrations
{
    ...
    [Migration("20251119121204_AddPackageRegistryMappings")]
    partial class AddPackageRegistryMappings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.ModuleVersion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleasedAt = new DateTime(2025, 11, 19, 12, 12, 4, 529, DateTimeKind.Utc).AddTicks(474),
                        ...
                        new
                        {
                            ...
                            ReleasedAt = new DateTime(2025, 11, 26, 12, 12, 4, 529, DateTimeKind.Utc).AddTicks(478),
                            SupportedStacksJson = "[\"DotNet\",\"NodeJS\"]",
                            Version = "1.1.0"
                        });
                });
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.PackageRegistryMapping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 11, 19, 12, 12, 4, 529, DateTimeKind.Utc).AddTicks(523),
                            ModuleId = 1,
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 11, 19, 12, 12, 4, 529, DateTimeKind.Utc).AddTicks(241),
                            Email = "admin@primussaas.com",
                            PasswordHash = "$2a$11$1cpBqvDSeWEpe8eDpouWDude7DsvSAJ6wtI9Ja4guFVMFPvzZmAuO",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 19, 12, 12, 4, 529, DateTimeKind.Utc).AddTicks(242)
                        });
                });
