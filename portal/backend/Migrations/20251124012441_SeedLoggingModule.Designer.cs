...
namespace PrimusSaaS.Portal.Api.Migrations
{
    ...
    [Migration("20251124012441_SeedLoggingModule")]
    partial class SeedLoggingModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.ModuleVersion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleasedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4817),
                        ...
                        new
                        {
                            ...
                            ReleasedAt = new DateTime(2025, 12, 1, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4821),
                            SupportedStacksJson = "[\"DotNet\",\"NodeJS\"]",
                            Version = "1.1.0"
                        },
                        new
                        {
                            ...
                            ReleasedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4846),
                            SupportedStacksJson = "[\"DotNet\",\"NodeJS\"]",
                            Version = "1.0.0"
                        });
                });

            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("EmailOnBreakingChange")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EmailOnNewVersion")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("EmailOnSecurityUpdate")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.PackageRegistryMapping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4871),
                            ModuleId = 1,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4873),
                            ModuleId = 1,
                        ...
                        {
                            Id = 100,
                            CreatedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4875),
                            ModuleId = 2,
                        ...
                        {
                            Id = 101,
                            CreatedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4877),
                            ModuleId = 2,
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4558),
                            Email = "admin@primussaas.com",
                            PasswordHash = "$2a$11$1cpBqvDSeWEpe8eDpouWDude7DsvSAJ6wtI9Ja4guFVMFPvzZmAuO",
                            Role = 1,
                            UpdatedAt = new DateTime(2025, 11, 24, 1, 24, 40, 854, DateTimeKind.Utc).AddTicks(4559)
                        });
                });
            ...
            modelBuilder.Entity("PrimusSaaS.Portal.Api.Models.NotificationPreference", b =>
                {
                    b.HasOne("PrimusSaaS.Portal.Api.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("PrimusSaaS.Portal.Api.Models.NotificationPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
