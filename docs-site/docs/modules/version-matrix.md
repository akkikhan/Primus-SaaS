...
| --- | --- | --- | --- | --- |
| Identity Validator | .NET | `PrimusSaaS.Identity.Validator` | 1.3.0 | ASP.NET Core auth handler + diagnostics |
| Identity Validator | Node.js | `@primus-saas/identity-validator` | 1.3.2 | Express/NestJS middleware + headless validator |
...
| Document Renderer | .NET | `Primus.Documents` | 1.0.0 | Text/Markdown/HTML to PDF |
